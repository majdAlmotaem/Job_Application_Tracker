...
export const StatsDashboard: React.FC<StatsDashboardProps> = ({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
      ...
      <div className="professional-card p-5 flex flex-col justify-between group relative overflow-hidden">
          ...
          <div className="space-y-1">
            ...
            {isEditing ? (
              ...
              <div className="flex items-center gap-2 mt-1.5">
                <span className="text-3xl font-extrabold text-slate-100 block tracking-tight">
                  {addedToday}
                ...
                <button
                  ...
                  className="opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity duration-150 p-1 hover:bg-slate-800 rounded text-slate-400 hover:text-white border-none cursor-pointer bg-transparent"
      ...
      <div className="professional-card p-5 flex flex-col justify-center">
        ...
        <span className="text-3xl font-bold text-slate-100 block mt-2 tracking-tight">
          {metrics.total}
        </span>
      </div>
      ...
      <div className="professional-card p-5 flex flex-col justify-center">
        ...
        <span className="text-3xl font-bold text-amber-500 dark:text-amber-400 block mt-2 tracking-tight">
      ...
      <div className="professional-card p-5 flex flex-col justify-center">
        ...
        <span className="text-3xl font-bold text-emerald-400 block mt-2 tracking-tight">
          {metrics.offers}
        </span>
      </div>
      ...
      <div className="professional-card p-5 flex flex-col justify-center">
        ...
        <span className="text-3xl font-bold text-rose-500 dark:text-rose-455 block mt-2 tracking-tight">
          {metrics.rejected}
        </span>
      </div>
    </div>
